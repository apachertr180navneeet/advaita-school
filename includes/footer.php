<?php
/**
 * Footer Component - Advaita School of Excellence
 * Premium Dark Footer UI with Stats Bar, Contact Cards & Watermark
 * Clean Semantic HTML - Strictly No Inline CSS
 */
?>
    <!-- Sticky Side Quick Action Pill -->
    <a href="#enquiry-form" class="adv-sticky-enquiry-pill" title="Admissions Enquiry">
    ...
    <footer class="adv-footer-wrapper">
                ...
                <div class="adv-footer-grid">
                    ...
                    <div class="adv-footer-brand">
                        ...
                        <div class="adv-footer-socials">
                            ...
                            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" class="adv-footer-social-btn instagram" title="Instagram" aria-label="Instagram">
                                <i class="fa-brands fa-instagram"></i>
                            </a>
                            <a href="https://wa.me/919876543210" target="_blank" rel="noopener noreferrer" class="adv-footer-social-btn whatsapp" title="WhatsApp" aria-label="WhatsApp">
                                <i class="fa-brands fa-whatsapp"></i>
                            </a>
                            <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" class="adv-footer-social-btn youtube" title="YouTube" aria-label="YouTube">
                                <i class="fa-brands fa-youtube"></i>
                            </a>
                            <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" class="adv-footer-social-btn linkedin" title="LinkedIn" aria-label="LinkedIn">
                    ...
                    <!-- Column 4: Visit Us & Contact Info -->
                    <div class="adv-footer-col">
                        <h4 class="adv-footer-col-title">Visit Us</h4>
                        <div class="adv-footer-contact-list">
                            <!-- Campus Address -->
                            <div class="adv-footer-contact-card">
                                <div class="adv-footer-contact-icon-box">
        ...
        <!-- Middle Affiliation & Milestones Strip -->
        <div class="adv-footer-stats-strip">
            <div class="adv-container adv-footer-stats-container">
                ...
                <span class="adv-footer-stat-item">
                    ...
                    <span>100% BOARD PASS · CLASS X & XII 2025</span>
                </span>
                <span class="adv-footer-stat-dot">•</span>
                <span class="adv-footer-stat-item">
                    <i class="fa-solid fa-users"></i>
                    <span>1500+ STUDENTS · 80+ FACULTY</span>
                </span>
            </div>
        </div>

        <!-- Bottom Copyright Strip -->
        <div class="adv-footer-bottom-strip">
