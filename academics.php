        ...
        <div class="adv-container">
            <div class="adv-banner-content">
                <span class="adv-banner-eyebrow">
                    <i class="fa-solid fa-book-open"></i> ACADEMIC EXCELLENCE
                </span>
                ...
                <ul class="adv-breadcrumb">
                    ...
                    <li><a href="academics.php">Learning</a></li>
                    <li class="adv-breadcrumb-sep"><i class="fa-solid fa-chevron-right"></i></li>
                    <li class="adv-breadcrumb-active">CBSE Curriculum</li>
                </ul>
            </div>
        </div>
    </section>
            ...
            <div class="adv-inner-grid">
                ...
                <aside class="adv-sidebar">
                    ...
                    <div class="adv-widget-cta">
                        ...
                        <p>Stream selection counseling and registrations open for Class XI (Science, Commerce, Arts).</p>
                        <a href="admissions.php" class="btn-cta">Enquire for Admissions</a>
                    </div>
                </aside>
